...
const tiltItems = document.querySelectorAll('.tilt-card, .nav a, .project-link, .inline-links a, .contact-links a, .contact-email');
const magneticItems = document.querySelectorAll('.magnetic, .contact-email, .contact-links a, .project-link');
